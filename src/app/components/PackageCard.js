...
export default function PackageCard({
  ...
  const handleQuickView = (e) => {
    e.preventDefault(); // Prevent navigation to the detailed page
    e.stopPropagation();
  ...
  return (
    <motion.div variants={cardVariants} className="h-full">
      <Link href="/destinations" className="group block h-full bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 ease-out border border-gray-100 hover:border-blue-100">
        
        {/* --- 1. Image Container (CHANGED to 4:3) --- */}
        <div className="relative aspect-[4/3] w-full overflow-hidden">
          ...
          {/* Wishlist Button (Placeholder for now) */}
          ...
          {/* Main Image with Slow Zoom Hover */}
          <Image
            src={imageUrl}
          ...
          {/* Key Info Overlay at Bottom of Image */}
        ...
        <div className="p-5 flex flex-col justify-between flex-grow">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div>
             ...
             {/* Subtle arrow that appears on hover to indicate "Go" */}
