...
// 1. We put the paths at the VERY TOP so they load first
const socialPaths = {
...
// 2. Then we define the SocialIcon component
const SocialIcon = ({ path, href }) => (
  ...
  >
    <svg
      className="w-7 h-7 text-gray-400 hover:text-[#ff7f32] transition-all transform hover:scale-110"
      fill="currentColor"
      viewBox="0 0 24 24"
...
// 3. Finally, the main Footer function
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
          ...
          <div className="col-span-2 lg:col-span-1 space-y-6">
            ...
            <div className="flex space-x-6 pt-2">
              <SocialIcon 
                href="https://www.facebook.com/profile.php?id=61582067495111" 
                path={socialPaths.facebook} 
              />
              <SocialIcon 
                href="https://www.instagram.com/globetrailtravels_pvt_ltd?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" 
                path={socialPaths.instagram} 
              />
              <SocialIcon 
                href="https://www.linkedin.com/company/globetrail-travels/" 
